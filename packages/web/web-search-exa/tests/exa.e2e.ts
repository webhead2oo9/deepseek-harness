...
import { ExaSearchProvider, EXA_DEFAULT_BASE_URL, EXA_DEFAULT_MODERATION, EXA_DEFAULT_SEARCH_TYPE } from '@deepseek-ai/dsh-web-search-exa'
...
maybe('ExaSearchProvider real API', () => {
  it('returns sources for a live query', async () => {
    const provider = new ExaSearchProvider(() => ({
      ...
      moderation: EXA_DEFAULT_MODERATION,
    }))
