...
import modelAuthRemote from '@deepseek-ai/dsh-model-auth/remote'
...
export type {} from '@deepseek-ai/dsh-model-auth/remote'
...
export type {} from '@deepseek-ai/dsh-model-auth/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote, modelAuthRemote,
    ]) {
