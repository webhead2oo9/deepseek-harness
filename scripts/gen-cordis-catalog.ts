...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  RequestAdmissionAction: 'core.md',
  ...
  ModelAuthAccount: 'credentials.md',
  ModelAuthorization: 'credentials.md',
  ModelAuthDriver: 'credentials.md',
  ModelAuthLoginAttemptId: 'credentials.md',
  ModelAuthLoginChallenge: 'credentials.md',
  ModelAuthLoginMethod: 'credentials.md',
  ModelAuthProviderId: 'credentials.md',
  ModelAuthProviderStatus: 'credentials.md',
