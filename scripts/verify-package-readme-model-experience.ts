...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/credentials/model-auth': { kind: 'indirect', reason: 'The seam resolves model-provider authorization; the consuming adapter owns every model-facing request it authorizes.' },
  'packages/credentials/model-auth-local': { kind: 'indirect', reason: 'The local provider stores model authorization records; registered drivers and their adapters own every model-facing request.' },
